                  ...
                  <div class="col-md-6">
                     <div class="contact-info">
                        ...
                        <div class="kode-forminfo">
                           <p>These are the information regarding our company. You can contact us using the Address, Phnone Number, Email below.</p>
                           <ul class="kode-form-list">
                              <li>
                                 <i class="fa fa-home"></i> 
                                 <p><strong>Address:</strong> #108E, 213, Boung Salang, Toul Kork, Phnom Penh</p>
                              </li>
                              <li>
                                 <i class="fa fa-phone"></i> 
                                 <p><strong>Phone:</strong>  098 909 220</p>
                              </li>
                              <li>
                                 <i class="fa fa-envelope-o"></i> 
                                 <p><strong>Email:</strong> jackson@gmail.com</p>
                              </li>
                           </ul>
                        </div>
                     </div>
